...
<section>
	...
	<H2 align="center" style="padding: 30px;">회원목록조회/수정</H2>
	...
	<div align="center">
		<table border="1">
			...
			%>
			<tr>
				<th><a id="custno" href="modify.jsp"><%=dto.getCustno() %></a></th><th id="custname"><%=dto.getCustname() %></th><th id="phone"><%=dto.getPhone() %></th><th id="address"><%=dto.getAddress() %></th><th id="joindate"><%=dto.getJoindate() %></th><th id="grade"><%=grade %></th><th id="city"><%=dto.getCity() %></th>
				</tr>
			<%} %>
		</table>	
		</div>
